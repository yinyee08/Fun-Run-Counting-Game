...
public class RoadSpawner : MonoBehaviour {
	...
	private void Update () 
	{
		//Prefabs.transform.Translate(0,0,5.5f*Time.deltaTime);
		/*foreach(GameObject active_prefabs in ActivePrefabs){
			active_prefabs.transform.Translate(0,0,-5.5f*Time.deltaTime);
		}*/
